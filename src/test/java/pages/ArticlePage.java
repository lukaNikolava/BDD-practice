...
public class ArticlePage extends Form {
	...
	private final IButton pageInformationBtn = getElementFactory().getButton(By.id("t-info"), "Page Information Button");
	private final ILabel searchedText = getElementFactory().getLabel(By.id("firstHeading"), "Searched Text");

	public ArticlePage() {
		super(By.xpath("//div[@id='bodyContent']//div[@id='mw-content-text']"), "Article Page");
	}
